...
def module_sequence(name, max_digits):
    ...
    NM.add_default_neuron('init flag', 0, [1], ['#OFF#'])
    NM.add_default_neuron('carry flag', 0, [1], ['#OFF#'])
    NM.add_default_neuron('off flag', 0, [1], ['#OFF#'])
    ...
    NM.add_default_neuron('0 neuron', 1, [1,1], ['init flag S0', '0 neuron S0'])
    ...
    for k in range(1, max_digits): # max_digits + 1?
        ...
        NM.add_default_neuron(neuron_label, layer, [2,1,1], [synapse_label, previous_synapse_label, 'carry flag S0'])
