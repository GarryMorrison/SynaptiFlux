...
if __name__ == '__main__':
    ...
    NM.add_neuron('1 neuron', 0, [1,1], ['#INIT#', '1 neuron S0'], sf.trigger_dot_product_threshold, {'threshold':1}, sf.pooling_xor, {})
    NM.append_neuron_pattern('1 neuron', [1,1], ['1 neuron S0', 'carry flag S0'], sf.trigger_dot_product_threshold, {'threshold':2})
    NM.add_neuron('2 neuron', 0, [2,1,1], ['2 neuron S0','1 neuron S0','carry flag S0'], sf.trigger_dot_product_threshold, {'threshold':2}, sf.pooling_xor, {})
    NM.append_neuron_pattern('2 neuron', [1,1], ['2 neuron S0', 'carry flag S0'], sf.trigger_dot_product_threshold, {'threshold':2})
    NM.add_neuron('3 neuron', 0, [2,1,1], ['3 neuron S0','2 neuron S0','carry flag S0'], sf.trigger_dot_product_threshold, {'threshold':2}, sf.pooling_xor, {})
    NM.append_neuron_pattern('3 neuron', [1,1], ['3 neuron S0', 'carry flag S0'], sf.trigger_dot_product_threshold, {'threshold':2})
    NM.add_neuron('4 neuron', 0, [2,1,1], ['4 neuron S0','3 neuron S0','carry flag S0'], sf.trigger_dot_product_threshold, {'threshold':2}, sf.pooling_xor, {})
