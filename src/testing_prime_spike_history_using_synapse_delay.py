...
if __name__ == '__main__':
    ...
    NM.add_neuron('not prime', 1, [-10, -10, -10, 1,1,1,1], ['init D1','init D2','init D4', 'init D0','#ALT-2#','#ALT-3#','#ALT-5#'], sf.trigger_dot_product_threshold, {'threshold':1}, sf.pooling_or, {})
    NM.add_neuron('init neuron', 0, [1], ['#INIT#'], sf.trigger_dot_product_threshold, {'threshold':1}, sf.pooling_or, {})
    NM.add_synapse("init", "init neuron", sf.synapse_delayed_identity, {'sign': 1, 'delay': 0}, sf.action_null, {})
