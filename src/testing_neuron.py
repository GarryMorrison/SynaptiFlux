...
if __name__ == '__main__':
    ...
    N0 = sf.Neuron("first neuron", [0,1,2,3], ['alpha S0', 'beta S0', 'gamma S0', 'delta S0'], sf.trigger_dot_product_threshold, {'threshold':1}, sf.pooling_or, {})
    ...
    N1 = sf.Neuron("second neuron", [1,1,1,1,1], ['a S0', 'b S0', 'c S0', 'd S0', 'e S0'], sf.trigger_dot_product_threshold, {'threshold':1}, sf.pooling_or, {})
    N1.append_to_axon(1)
    N1.append_to_axon(1)
    N1.append_to_axon(0)
    N1.append_to_axon(1)
