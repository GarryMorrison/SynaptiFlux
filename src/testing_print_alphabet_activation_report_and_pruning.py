"""A quick test of printing the start of the alphabet using default functions, and activation reports and neuron/synapse pruning."""
...
if __name__ == '__main__':
    print("Testing activation reports and neuron and synapse pruning:")
